...
<section class="webdesigntuts-workshop">
	<form action="../php/searchmedicine.php" method="post" onSubmit="return check(this)">		    
...
<table class="hovertable" style='text-align:center;' border='1'>
	<tr><th>编号</th><th>名字</th><th>售价（元）</th><th>类别</th><th>详情</th><th>修改</th><th>删除</th></tr>
<?php 
	...
	if($DataCount>0){
		...
		echo "<tr><td>$mid</td><td>$mname</td><td>$price</td><td>$class</td><td><a style='text-decoration:none;' href='../php/viewmedicine.php?mid=$mid'>详情</a></td>
		<td><a style='text-decoration:none;' href='../php/ADeditmedicine_1.php?mid=$mid'>修改</a></td>
		<td><a style='text-decoration:none;' href='../php/ADdeletemedicine.php?mid=$mid'>删除</a></td></tr>";
	}
	}
	else
	{
		echo "<script>alert('查询不到！');window.location.href='../php/ADallmedicine.php';</script>";
