...
<table class="hovertable" style='text-align:center;' border='1'>
	<tr><th>序号</th><th>编号</th><th>名字</th><th>售价（元）</th><th>类别</th><th>详情</th><th>修改</th><th>删除</th></tr>
<?php 
	$id=1;
    $Page_size=5; 
	...
	if($Page_size>=$DataCount)
	{
		...
		echo $id++;
		echo "</td>";
		echo "<td>$mid</td><td>$mname</td><td>$price</td><td>$class</td><td><a style='text-decoration:none;' href='../php/viewmedicine.php?mid=$mid'>详情</a></td>
		<td><a style='text-decoration:none;' href='../php/ADeditmedicine_1.php?mid=$mid'>修改</a></td>
		<td><a style='text-decoration:none;' href='../php/ADdeletemedicine.php?mid=$mid' onclick='javascript:return del();'>删除</a></td></tr>";	
		}
	}
	else
	{
