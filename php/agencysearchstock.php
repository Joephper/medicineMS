...
<body>
<p class="font">仓库信息管理 > 库存信息管理> 查询库存信息</p>
<section class="webdesigntuts-workshop">
	<form action="../php/agencysearchstock.php" method="post" onSubmit="return check(this)">		    
...
<table class="hovertable" style='text-align:center;' border='1'>
	<tr><th>药品编号</th><th>商品批号</th><th>库存总量</th></tr>
<?php 
	...
	if($DataCount>0){
		...
		echo "<tr><td><a style='text-decoration:none;color:black;' href='../php/viewmedicine.php?mid=$mid'><i>$mid</i></a></td><td><a style='text-decoration:none;color:black;' href='../php/viewinput.php?ino=$ino'><i>$ino</i></a></td><td>$snum</td></tr>";
	}
	}
	else
	{
		echo "<script>alert('查询不到！');window.location.href='../php/agencyallstock.php';</script>";
