...
<?php 
	$id=1;
    $Page_size=5; 
	$result=mysql_query("SELECT * FROM $my_agency"); //查询suppliers表所有数据
	...
	$sql="select * from $my_agency limit $offset,$Page_size"; 
	...
	if($Page_size>=$DataCount)
	{
		...
		<td><a style='text-decoration:none;' href='../php/ADdeleteagency.php?aid=$aid' onclick='javascript:return del();'>删除</a></td></tr>";
...
<div align="center"><p>系统中共有<?php echo "$DataCount";?>条经办人信息。</p></div>
</div>
</body>
</html>
