...
<?php 
	...
	if($Page_size>=$DataCount)
	{
		...
		<td><a style='text-decoration:none;' href='../php/ADeditoutput_1.php?oid=$oid'>修改</a></td><td><a style='text-decoration:none;' href='../php/ADdeleteoutput.php?oid=$oid' onclick='javascript:return del();'>删除</a></td></tr>";	
		}
	}
	else{
