...
<body>
<p class="font">药品信息管理 > 浏览药品信息</p>
<section class="webdesigntuts-workshop">
	<form action="../php/agencysearchmedicine.php" method="post" onSubmit="return check(this)">		    
...
<?php 
	...
	if($DataCount>0){
		...
		echo "<tr><td>$mid</td><td>$mname</td><td>$price</td><td>$class</td>
		<td><a style='text-decoration:none;' href='../php/viewmedicine.php?mid=$mid'>详情</a></td></tr>";
	}
	}
	else
	{
		echo "<script>alert('查询不到！');window.location.href='../php/agencyallmedicine.php';</script>";
