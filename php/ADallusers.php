...
<table class="hovertable" style='text-align:center;' border='1'>
	<tr><th>序号</th><th>编号</th><th>名字</th><th>性别</th><th>手机号</th><th>详情</th><th>修改</th><th>删除</th></tr>
<?php 
	$hid=1;
    $Page_size=5; 
	$result=mysql_query("SELECT * FROM users"); //查询suppliers表所有数据
	...
	$sql="select * from $my_user limit $offset,$Page_size"; 
	...
	if($Page_size>=$DataCount){
		...
		echo $hid++;
		echo "</td>";
		echo "<td>$id</td><td>$name</td><td>$sex</td>
...
<div align="center"><p>系统中共有<?php echo "$DataCount";?>条用户信息。</p></div>
</div>
</body>
</html>
